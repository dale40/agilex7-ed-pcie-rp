...
set_global_assignment -name IP_FILE ../src/ip/subsys_pcie/subsys_pcie_systemclk_f_0.ip
...
#set_global_assignment -name IP_FILE ../src/ip/subsys_pcie/subsys_pcie_intel_pcie_ftile_mcdma_dev_1.ip
set_global_assignment -name IP_FILE ../src/ip/subsys_pcie/subsys_pcie_intel_pcie_ftile_mcdma_0.ip
set_global_assignment -name IP_FILE ../src/ip/subsys_pcie/Pcie_mm_ccb_8gb_1.ip
...
set_global_assignment -name IP_FILE ../src/ip/subsys_pcie/msi_to_gic_gen.ip
