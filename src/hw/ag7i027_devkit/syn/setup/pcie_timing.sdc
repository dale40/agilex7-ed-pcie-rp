...
set_clock_groups -asynchronous -group [get_clocks {soc_ins:wt|subsys_pcie_0|intel_pcie_ftile_mcdma_0|intel_pcie_ftile_mcdma_0|ast_hip|intel_pcie_ftile_ast_hip|rx_clkout|ch5}]
